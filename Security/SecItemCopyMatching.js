/*
 * Auto-generated by Frida. Please modify to match the signature of SecItemCopyMatching.
...
{
    /**
     * Called synchronously when about to call SecItemCopyMatching.
     *
    ...
    onEnter: function (log, args, state) {
        log("[+] Keychain operation: SecItemCopyMatching");
    ...
    /**
     * Called synchronously when about to return from SecItemCopyMatching.
     *
    ...
    onLeave: function (log, retval, state) {
        var result = ObjC.Object(this.result);
        log(result); // NOT WORKING AT ALL.
    }
}
